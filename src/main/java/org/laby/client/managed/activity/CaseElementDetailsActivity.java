...
public class CaseElementDetailsActivity extends CaseElementDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<CaseElementProxy> view;

    private AcceptsOneWidget display;

    public CaseElementDetailsActivity(EntityProxyId<org.laby.client.managed.request.CaseElementProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<org.laby.client.managed.request.CaseElementProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.caseElementRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(CaseElementProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((CaseElementProxy) proxy);
