...
public class BonusDetailsActivity extends BonusDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<BonusProxy> view;

    private AcceptsOneWidget display;

    public BonusDetailsActivity(EntityProxyId<org.laby.client.managed.request.BonusProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<org.laby.client.managed.request.BonusProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.bonusRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(BonusProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((BonusProxy) proxy);
