...
import org.laby.client.managed.ui.NiveauDetailsView.Binder;
import org.laby.client.scaffold.place.ProxyDetailsView;
import org.laby.client.scaffold.place.ProxyListView;

public class NiveauDetailsView extends NiveauDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.laby.client.managed.ui.NiveauDetailsView instance;
    ...
    public NiveauDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static org.laby.client.managed.ui.NiveauDetailsView instance() {
        if (instance == null) {
            instance = new NiveauDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, NiveauDetailsView> {
    }
}
