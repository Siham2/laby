...
public abstract class MechantMobileListView_Roo_Gwt extends MobileProxyListView<MechantProxy> {

    protected Set<String> paths = new HashSet<String>();

    public MechantMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.laby.client.managed.request.MechantProxy> renderer) {
