...
public class MechantMobileListView extends MechantMobileListView_Roo_Gwt {

    private static org.laby.client.managed.ui.MechantMobileListView instance;

    public MechantMobileListView() {
        super("New Mechant", new CellRenderer());
        init();
    }

    public static org.laby.client.managed.ui.MechantMobileListView instance() {
        if (instance == null) {
            instance = new MechantMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<MechantProxy> {
        ...
        @Override
        public SafeHtml render(MechantProxy value) {
            if (value == null) {
