...
public class BonusMobileListView extends BonusMobileListView_Roo_Gwt {

    private static org.laby.client.managed.ui.BonusMobileListView instance;

    public BonusMobileListView() {
        super("New Bonus", new CellRenderer());
        init();
    }

    public static org.laby.client.managed.ui.BonusMobileListView instance() {
        if (instance == null) {
            instance = new BonusMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<BonusProxy> {
        ...
        @Override
        public SafeHtml render(BonusProxy value) {
            if (value == null) {
