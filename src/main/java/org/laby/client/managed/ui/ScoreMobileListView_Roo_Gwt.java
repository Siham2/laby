...
public abstract class ScoreMobileListView_Roo_Gwt extends MobileProxyListView<ScoreProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ScoreMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.laby.client.managed.request.ScoreProxy> renderer) {
