...
public abstract class CaseElementMobileListView_Roo_Gwt extends MobileProxyListView<CaseElementProxy> {

    protected Set<String> paths = new HashSet<String>();

    public CaseElementMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.laby.client.managed.request.CaseElementProxy> renderer) {
