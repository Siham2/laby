...
public abstract class BonusDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<BonusProxy> {
    ...
    public void setValue(BonusProxy proxy) {
        ...
        displayRenderer.setInnerText(org.laby.client.managed.ui.BonusProxyRenderer.instance().render(proxy));
    }
}
