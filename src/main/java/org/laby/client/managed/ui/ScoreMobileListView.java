...
public class ScoreMobileListView extends ScoreMobileListView_Roo_Gwt {

    private static org.laby.client.managed.ui.ScoreMobileListView instance;

    public ScoreMobileListView() {
        super("New Score", new CellRenderer());
        init();
    }

    public static org.laby.client.managed.ui.ScoreMobileListView instance() {
        if (instance == null) {
            instance = new ScoreMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<ScoreProxy> {
        ...
        @Override
        public SafeHtml render(ScoreProxy value) {
            if (value == null) {
