...
public class CaseElementMobileListView extends CaseElementMobileListView_Roo_Gwt {

    private static org.laby.client.managed.ui.CaseElementMobileListView instance;

    public CaseElementMobileListView() {
        super("New CaseElement", new CellRenderer());
        init();
    }

    public static org.laby.client.managed.ui.CaseElementMobileListView instance() {
        if (instance == null) {
            instance = new CaseElementMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<CaseElementProxy> {
        ...
        @Override
        public SafeHtml render(CaseElementProxy value) {
            if (value == null) {
